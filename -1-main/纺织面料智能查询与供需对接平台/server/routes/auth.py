"""Authentication routes for the textile fabric platform.
...
def update_profile():
    ...
    Request JSON:
        ...
        role (str, optional): Only for new users selecting role
    ...
    if 'role' in data and data['role'] in ('buyer', 'supplier'):
        user.role = data['role']
